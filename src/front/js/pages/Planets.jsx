    ...
    return (
        <div className="container mt-5">
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                {
                    store.planetList.map((iterator) => (
                        <div className="col" key={iterator.uid}>
                            <div className="card h-100" style={{ width: "18rem" }}>
                                <img src={`https://raw.githubusercontent.com/tbone849/star-wars-guide/refs/heads/master/build/assets/img/planets/${iterator.uid}.jpg`}
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <Link to={`/planet/${iterator.uid}`} onClick={() => actions.getDetailsPlanet(iterator.url, iterator.uid)} className="btn btn-dark rounded-4">Description</Link>
